...
from .utils import generate_reaction_ode_dataset, generate_wrong_reaction_ode_dataset
...
def evaluate_finetuned_pinns(config: ml_collections.ConfigDict, workdir: str):
    ...
    # 計算外部驅動力 f
    f_pred_torch = model.f_function(t_torch, params['lambda'], u_pred_torch)
