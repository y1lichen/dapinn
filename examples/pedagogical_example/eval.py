...
#     # Calculate L2 Error
#     t_col_points = model.t_col.detach().cpu().numpy().ravel()
#     l2_error = np.linalg.norm(u_pred - u_true) / np.linalg.norm(u_true)
#     print(f"Relative L2 Error: {l2_error:.6e}")

#     plt.figure(figsize=(10, 6))
#     # plt.scatter(t_col_points, np.zeros_like(t_col_points) - 0.05, 
#                 # color='gray', s=10, marker='|', alpha=0.5, label="Collocation Points")
