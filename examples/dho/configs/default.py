...
def get_config():
    ...
    # config.finetune_correction_optim = optimizer_config(lr=1e-4, optimizer="Adam", scheduler="Exp", gamma=0.9) # 0.5

    config.pretrain_optim = optimizer_config(lr=1e-3, optimizer="Adam", scheduler="Exp", gamma=0.9)
    config.finetune_pinns_optim = optimizer_config(lr=1e-3, optimizer="Adam", scheduler="Exp", gamma=0.9)
    config.finetune_correction_optim = optimizer_config(lr=1e-3, optimizer="Adam", scheduler="Exp", gamma=0.9) # 0.5
    ...
    config.pretraining = training_config(max_epochs=100000, u_w=1.0, f_w=1.0)
